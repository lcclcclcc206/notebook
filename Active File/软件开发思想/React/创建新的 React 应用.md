...
如果你没有碰到上述的问题，或者还不习惯使用 JavaScript 工具，可以考虑[把 React 作为普通的 `` 标记添加到 HTML 页面上](https://zh-hans.reactjs.org/docs/add-react-to-a-website.html)，以及[使用可选的 JSX](https://zh-hans.reactjs.org/docs/add-react-to-a-website.html#optional-try-react-with-jsx)。
