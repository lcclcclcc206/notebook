...
从 [Microsoft.Web.LibraryManager.Cli](https://www.nuget.org/packages/Microsoft.Web.LibraryManager.Cli/) NuGet 包安装 [.NET Core 全局工具](https://learn.microsoft.com/zh-cn/dotnet/core/tools/global-tools#install-a-global-tool)。
...
- 键入默认提供程序的名称，或按 `Enter` 以使用默认 CDNJS 提供程序。 有效值包括：
  ...
  ![libman 初始化命令 - 默认提供程序](https://learn.microsoft.com/zh-cn/aspnet/core/client-side/libman/_static/libman-init-provider.png?view=aspnetcore-7.0)
...
使用文件系统提供程序从 C:\temp\contosoCalendar\ 安装 `calendar.js` 和 `calendar.css` 文件：
...
![libman 安装命令 - 目标](https://learn.microsoft.com/zh-cn/aspnet/core/client-side/libman/_static/libman-install-destination.png?view=aspnetcore-6.0)
