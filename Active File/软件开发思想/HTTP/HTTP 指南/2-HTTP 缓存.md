...
## [概览](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#概览)
...
### [私有缓存](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#私有缓存)
...
### [共享缓存](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#共享缓存)
...
另一方面，如果 [TLS](https://developer.mozilla.org/zh-CN/docs/Glossary/TLS) 桥接代理通过在 PC 上安装来自组织管理的 [CA (en-US)](https://developer.mozilla.org/en-US/docs/Glossary/Certificate_authority) 证书，以中间人方式解密所有通信，并执行访问控制等，则可以查看响应的内容并将其缓存。但是，由于[证书透明度（certificate transparency）](https://developer.mozilla.org/zh-CN/docs/Web/Security/Certificate_Transparency)在最近几年变得很普遍，并且一些浏览器只允许使用证书签署时间戳（signed certificate timestamp）颁发的证书，因此这种方法需要应用于企业策略。在这样的受控环境中，无需担心代理缓存“已过时且未更新”。
...
## [启发式缓存](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#启发式缓存)
...
## [基于 age 的缓存策略](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#基于_age_的缓存策略)
...
## [Expires 或 max-age](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#expires_或_max-age)
...
## [验证响应](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#验证响应)
...
### [If-Modified-Since](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#if-modified-since)
...
### [ETag/If-None-Match](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#etagif-none-match)
...
### [不与其他用户共享](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#不与其他用户共享)
...
### [每次都提供最新的内容](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#每次都提供最新的内容)
...
### [兼容过时的实现](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#兼容过时的实现)
...
### [`no-store` 丢失了什么](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#no-store_丢失了什么)
...
## [重新加载和强制重新加载](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#重新加载和强制重新加载)

可以对请求和响应执行验证。

**重新加载**和**强制重新加载**操作是从浏览器端执行验证的常见示例。

### [重新加载](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#重新加载)
...
### [强制重新加载](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#强制重新加载)
...
### [避免重新验证](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#避免重新验证)
...
## [删除存储的响应](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#删除存储的响应)
...
## [请求折叠](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#请求折叠)
...
### [默认设置](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#默认设置)
...
### [缓存破坏](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#缓存破坏)
...
### [验证响应](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#验证响应_2)
...
### [主要资源](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#主要资源)
...
### [有关托管缓存的更多信息](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Caching#有关托管缓存的更多信息)
